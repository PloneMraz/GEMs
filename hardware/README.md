...
| [`bom/`](bom/) | Engineering BOM: multi-level structure generated from the kinematics, item master, approved manufacturer list with source and price where verified | ◐ 230 parts, none priced |
