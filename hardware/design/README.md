...
|---|---|---|---|
| [`concept/`](concept/) | The author's concept art, AI-generated with Google Gemini: the original visual idea of the body — a reference, not a blueprint | input to ID-1 | ✅ two images |
...
concept art, only to the extent rights in it exist (see [`concept/`](concept/README.md#provenance-and-rights)); surface CAD, once it
