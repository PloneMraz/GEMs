...
| **C-8** | Agency classification precedes interpretation | Every change MUST be classified as self-caused or not **before** anything interprets it. Classification applied after fusion or compression does not satisfy this | **C**, **T** | [07.4](../spec/07-firmware-and-software.md#74-what-software-must-guarantee) |
...
[07.3](../spec/07-firmware-and-software.md#73-what-firmware-must-guarantee).
